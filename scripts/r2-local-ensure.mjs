#!/usr/bin/env node
/**
 * Ensure the LOCAL R2 bucket has product/category/page images for `npm run preview:dev`.
 *
 ...
 * and CMS-page image renders as a blank box until it is populated. This uploads
 * the images
...
const SOURCE_DIRS = ["data/r2/products", "data/r2/categories", "data/r2/pages"];
...
for (const dir of SOURCE_DIRS) {
  ...
  const folder = dir.split("/").pop(); // "products" | "categories" | "pages"
